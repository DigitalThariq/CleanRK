        ...
        <div className="w-full">
            ...
            <section className="py-20 bg-brand-gold/10">
                <div className="max-w-4xl mx-auto px-4 text-center flex flex-col items-center">
                    <h2 className="font-serif text-3xl font-bold text-brand-navy mb-2">Are You a Helper? We Want to Hear From You</h2>
                    ...
                    <Link to="/contact?type=helper">
                        <Button variant="primary">Register as a Helper / Daftar sebagai ART</Button>
                    </Link>
                </div>
            </section>
        </div>
