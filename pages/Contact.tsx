                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-brand-charcoal">hello@adel.com.sg</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                    ...
                    {activeTab === 'family' ? (
                        ...
                        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div>
                                ...
                                <input type="text" className="w-full border border-gray-300 rounded p-3 focus:outline-none focus:border-brand-navy" placeholder="Your Name / Nama Anda" />
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 mt-2">
                                    <label className="flex items-center gap-2">
                                        <input type="radio" name="experience" value="yes" /> Yes (Ya)
                                    </label>
                                    <label className="flex items-center gap-2">
                                        <input type="radio" name="experience" value="no" /> No (Tidak)
                                    </label>
                                </div>
                            </div>
                            <div>
                                ...
                                <textarea className="w-full border border-gray-300 rounded p-3 focus:outline-none focus:border-brand-navy h-32" placeholder="Tell us a bit about your experience and skills... (Ceritakan pengalaman dan keahlian anda...)"></textarea>
                            </div>
